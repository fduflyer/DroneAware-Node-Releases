...
```bash
curl -fsSL https://github.com/fduflyer/DroneAware-Node-Releases/releases/download/v1.0.27/install.sh | sudo bash
```
...
4. **Install system packages and download binaries** from the
   [v1.0.27 release](https://github.com/fduflyer/DroneAware-Node/releases/tag/v1.0.27).
