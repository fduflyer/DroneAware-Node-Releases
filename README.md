...
```bash
curl -fsSL https://github.com/fduflyer/DroneAware-Node-Releases/releases/download/v1.1.0/install.sh | sudo bash
```
...
4. **Install system packages and download binaries** from the
   [v1.1.0 release](https://github.com/fduflyer/DroneAware-Node/releases/tag/v1.1.0).
